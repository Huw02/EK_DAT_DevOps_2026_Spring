...
Understands various basic compose.yaml files.
...
link:00._Course_Material/01._Assignments/13._Deployment_Strategies_Orchestration_Maintenance/02._After/consider_a_deployment_strategy.md[Consider a deployment strategy]
...
| May 14th
a|
National holiday on the day but you still have the other hours of the week subtracted for course work.
Finish the report.
a|
No lecture.
a|
